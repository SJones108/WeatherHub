  ...
  return (  
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          <Input {...register('severity')} name='title' placeholder="Level Of Severity"/>
        </div>
        <div>
          <Input {...register('date_happened')} name='date_happened' placeholder="Date Happened"/>
        </div>
        <div>
          <Input {...register('damage_cost')} name='damage_cost' placeholder="Cost Of Damage"/>
        </div>
