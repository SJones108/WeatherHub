...
const columns: GridColDef[] = [
    ...
    { field: 'date_happened', headerName: 'Date Happened', flex: 1 },
    { field: 'damage_cost', headerName: 'Cost Of Damage', flex: 1 },
  ];
      ...
      <>
        ...
        <div className={ open ? "hidden" : "container mx-10 my-5 flex flex-col"}
          style={{ height: 400, width: '100%' }}>
            <h2 className="p-3 bg-slate-300 my-2 rounded">Weather Hub</h2>
            <DataGrid 
            rows={imageData} 
            columns={columns} 
